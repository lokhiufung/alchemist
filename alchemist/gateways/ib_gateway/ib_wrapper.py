...
class IBWrapper(EWrapper):
    ...
    def tickPrice(self, reqId: TickerId , tickType: TickType, price: float,
        ...
        if tickType not in self._subscribed_market_data_tick_types[product.pdt]:
            return
    ...
    def updateMktDepth(
        ...
        """
        Updates market depth data.

        Args:
            reqId (TickerId): The request ID for the market depth update.
            position (int): The position in the order book.
            operation (int): The operation code (e.g., insert, update, or delete).
            side (int): The side of the market (buy or sell).
            price (float): The price level.
            size (Decimal): The size at the price level.
    ...
    def updateMktDepthL2(
        ...
        """
        Updates Level 2 market depth data.

        Args:
            reqId (TickerId): The request ID for the Level 2 market depth update.
            position (int): The position in the Level 2 order book.
            marketMaker (str): The market maker identifier.
            operation (int): The operation code (e.g., insert, update, or delete).
            side (int): The side of the market (buy or sell).
            price (float): The price level.
            size (Decimal): The size at the price level.
            isSmartDepth (bool): Indicates whether smart depth is enabled.

        """
        self._update_orderbook(reqId, position, operation, side, price, size, 
                            marketMaker=marketMaker, isSmartDepth=isSmartDepth)
